...
var Scene2 = (function (_super) {
    ...
    p.initStage1 = function () {
        _super.prototype.initStage1.call(this);
        ...
        this.maskObj.addEventListener("complete", function (event) {
        ...
        this.maskObj2.addEventListener("complete", function (event) {
        ...
        this.maskObj3.addEventListener("complete", function (event) {
        ...
        this.maskObj4.addEventListener("complete", function (event) {
        ...
        this.maskObj5.addEventListener("complete", function (event) {
    ...
    p.onTouchBeginObj = function (event) {
    ...
    p.initStage2 = function () {
        _super.prototype.initStage2.call(this);
        this.textCurrentIndex = 0;
        this.textinfos = [
            {
                "source": "s1_txt7_fnt",
