...
(function (zmovie) {
    var ZMovieClip = (function (_super) {
        ...
        p.getCurrPlayLabel = function () {
            return this.currPlaylabel;
        };
        p.getCurrFrame = function () {
            return this.currFrame;
        };
        p.getIsPlay = function () {
            return this.isPlay;
        };
        p.setTimeScale = function (num) {
            if (0 >= num) {
                num = 0.01;
            }
            this._timeScale = num;
        ...
        p.gotoAndPlayLabel = function (label, isPlayToEnd) {
        ...
        p.setMovieObject = function (imgArr, libObj, mcName, scale_) {
            if (scale_ === void 0) { scale_ = 1; }
            if (null == mcName) {
                mcName = "root";
            }
    ...
    egret.registerClass(ZMovieClip,'zmovie.ZMovieClip');
})(zmovie || (zmovie = {}));
